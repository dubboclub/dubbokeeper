...
public class IndexController {
    ...
    public @ResponseBody Map<String, Integer> loadApplicationNodes() {
        ...
        Map<String, Integer> statistics = new HashMap<String, Integer>();
        for (Application application : applications) {
            if (Application.PROVIDER_AND_CONSUMER == application.getType()) {
                statistics.put(application.getApplication(), applicationService.getNodesByApplicationName(application.getApplication()).size() / 2);
            } else {
