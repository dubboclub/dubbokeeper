...
public interface StatisticsMapper {
    ...
    public Long queryMaxElapsed(@Param("application")String application,@Param("start")long start,@Param("end")long end);

    public Long queryMaxConcurrent(@Param("application")String application,@Param("start")long start,@Param("end")long end);

    public Integer queryMaxFault(@Param("application")String application,@Param("start")long start,@Param("end")long end);
